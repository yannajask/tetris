...
explicit Block::Block(std::vector<std::pair<int, int>> coordinates): coordinates(coordinates) {}
...
explicit IBlock::IBlock(): Block({{0, 0}, {1, 0}, {2, 0}, {3, 0}}) {}

explicit JBlock::JBlock(): Block({{0, 0}, {0, 1}, {1, 1}, {2, 1}}) {}

explicit LBlock::LBlock(): Block({{0, 1}, {1, 1}, {2, 1}, {2, 0}}) {}

explicit OBlock::OBlock(): Block({{1, 0}, {2, 0}, {1, 1}, {2, 1}}) {}

explicit SBlock::SBlock(): Block({{0, 1}, {1, 0}, {1, 1}, {0, 1}}) {}

explicit TBlock::TBlock(): Block({{0, 1}, {1, 0}, {1, 1}, {2, 1}}) {}

explicit ZBlock::ZBlock(): Block({{0, 0}, {1, 0}, {1, 1}, {2, 1}}) {}
